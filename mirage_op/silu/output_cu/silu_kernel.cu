...
static void _execute_mugraph(std::vector<void const *> input_tensors, std::vector<void*> output_tensors, void* buf, cudaStream_t stream, void * profiler_buffer){
  ...
  {
    // OP type: kn_silu_op
    bfloat16_t *dtensor10000004 = (bfloat16_t*)input_tensors.at(0);
    bfloat16_t *dtensor10000005 = (bfloat16_t*)output_tensors.at(0);
    using kernel = kn::ElementUnaryKernel<bfloat16_t, kn::ElementUnaryOpType::SILU, Layout<Shape<Int<3072>, Int<1>>, Stride<Int<1>, Int<3072>>>, Layout<Shape<Int<3072>, Int<1>>, Stride<Int<1>, Int<3072>>>>;
    kernel::run(dtensor10000005, dtensor10000004);
  }
  {
